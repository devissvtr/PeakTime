...
class FormViewModel(private val repository: FormRepository) : ViewModel() {
    fun submitForm(age: Int, task: String, averageRest: Int,
        ...
        averageWorkHour: Int,
        workDays: String
    ) = repository.formData(age, task, averageRest, moodBeforeWork, deadline, importance, sleepAverage, urgency, totalGangguan, averageWorkHour, workDays)
}